...
public class main {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		for (int i = 0; i < N; i++) {
			paramRange[i] = new Parameters(new int[] { 10000, 1, 1, 1 },
		...
		sim = new Simulator_new[N];
		threads = new Thread[N];

		for (int i = 0; i < N; i++) {
			sim[i] = new Simulator_new(paramRange[i]);
		}
	...
	private static void saveConfig(Simulator_new sim, String name) {
